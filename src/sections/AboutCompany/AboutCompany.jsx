			...
			<div className='about-company__inner container'>
				...
				<div className='about-company__wrapper'>
					<div className='about-company__body'>
						<p
							className='about-company__text text-lg'
							data-js-about-company-text
						>
						...
						<Button
							className='about-company__video-btn'
							label='Видеопрезентация'
							iconName='x-icon'
							iconPosition='before'
              mode='gray'
							data-js-video-modal-trigger='https://kinescope.io/cb6oH3dPLTZPRykEtEhERr'
						/>
					</div>
				</div>
			</div>
